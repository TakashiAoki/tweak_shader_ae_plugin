            ...
            match push_constants {
                ...
                PushConstant::Struct {
                    ...
                    for (_, input) in inputs.iter() {
                        ...
                        let req = input.std140_alignment();
                        offset += (req - (offset % req)) % req;
    ...
    fn new_struct_entry(
        ...
        let align = inputs
            ...
            .map(|(_, i)| match i {
                ...
                InputType::Point3(_) => std::mem::size_of::<[f32; 4]>(),
                _ => i.as_bytes().len(),
            })
            .max()
            .unwrap_or(0);
                ...
                match binding {
                    ...
                    BindingEntry::UniformBlock {
                        ...
                        for input in inputs.iter() {
                            ...
                            let req = input.1.std140_alignment();
                            offset += (req - (offset % req)) % req;
            ...
            match binding {
                ...
                BindingEntry::UniformBlock {
                    ...
                    for input in inputs.values() {
                        ...
                        // Advance to this member's std140 alignment boundary
                        let req = input.std140_alignment();
                        offset += (req - (offset % req)) % req;
